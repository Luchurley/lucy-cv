...
window.LUCY = {
  ...
  iaAgents: [
    ...
    { id: 'sheldon', name: 'Sheldon Holloway', age: '34 ans', domain: 'Finance · Investissement', role: 'Analyste · Conseiller financier pressé', tone: 'Brusque · Direct · Intolérant à la perte de temps', usage: `Finance, investissement, budget. Donne la réponse et passe à autre chose.`, designNote: `La brusquerie comme feature, pas comme bug.`, photo: 'assets/agents/sheldon.png', video: 'assets/videos/sheldon.mov' },
