...
window.LUCY = {
  ...
  projects: [
    {
      ...
      brianSection: {
        ...
        videos: [
          { src: 'assets/videos-projets/brian-demo-blagues.mp4', label: 'Blagues interactives — choix de la chute' },
          { src: 'assets/videos-projets/brian-demo-jokes.mp4', label: 'Dad jokes — contenu personnalisé' },
          { src: 'assets/videos-projets/brian-demo-articles.mp4', label: 'Articles — lecture en contexte' },
        ],
      ...
      missionComplete: {
        ...
        graphic: {
          ...
          videos: [
            { src: 'assets/videos-projets/tec-salon-flyer.mp4', label: 'Motion — Flyer événement' },
            { src: 'assets/videos-projets/tec-salon-print.mp4', label: 'Motion — Print stand' },
            { src: 'assets/videos-projets/tec-salon-rollup.mp4', label: 'Motion — Roll-up salon' },
            { src: 'assets/videos-projets/tec-social-padawan.mp4', label: 'Motion — Réseaux sociaux' },
          ],
        },
        marketing: {
    ...
    },
    {
      ...
      motionVideo: 'assets/videos-projets/jaccede-motion.mp4',
      desktopMocks: [
        { src: 'assets/projects/assets-bundle/jaccede/jaccede-lofidesktop-explore.jpeg', cap: 'Lo-fi — Explorer' },
        { src: 'assets/projects/assets-bundle/jaccede/jaccede-desktop-explore.jpg', cap: 'Hi-fi — Explorer' },
        { src: 'assets/projects/assets-bundle/jaccede/jaccede-desktop-home.jpg', cap: 'Hi-fi — Accueil' },
      ],
      uiKitGallery: [
        { src: 'assets/projects/assets-bundle/jaccede/jaccede-uikit-colors.jpeg', cap: 'Colors' },
        { src: 'assets/projects/assets-bundle/jaccede/jaccede-uikit-typo.jpeg', cap: 'Typo' },
        { src: 'assets/projects/assets-bundle/jaccede/jaccede-uikit-icons.jpeg', cap: 'Icons' },
        { src: 'assets/projects/assets-bundle/jaccede/jaccede-uikit-basecomponent.jpeg', cap: 'Base components' },
        { src: 'assets/projects/assets-bundle/jaccede/jaccede-uikit-cards.jpeg', cap: 'Cards' },
        { src: 'assets/projects/assets-bundle/jaccede/jaccede-uikit-formfield.jpeg', cap: 'Form fields' },
        { src: 'assets/projects/assets-bundle/jaccede/jaccede-uikit-searcharea.jpeg', cap: 'Search area' },
        { src: 'assets/projects/assets-bundle/jaccede/jaccede-uikit-media.jpeg', cap: 'Media' },
        { src: 'assets/projects/assets-bundle/jaccede/jaccede-uikit-layout.jpeg', cap: 'Layout' },
    ...
    },
    {
      ...
      desktopMocks: [
        { src: 'assets/projects/assets-bundle/wegoboard/wegoboard-avant.jpeg', cap: 'Avant' },
        { src: 'assets/projects/assets-bundle/wegoboard/wegoboard-home.jpeg', cap: 'Après — Homepage' },
        { src: 'assets/projects/assets-bundle/wegoboard/wegoboard-product-selection.jpg', cap: 'Sélection produit' },
      ],
    ...
    },
    {
      ...
      phoneMocks: [
        { src: 'assets/projects/equality-splash.jpg', cap: 'Splash' },
        { src: 'assets/projects/equality-login.jpg', cap: 'Connexion' },
        { src: 'assets/projects/equality-games.jpg', cap: 'Jeux favoris' },
        { src: 'assets/projects/equality-teams.jpg', cap: 'Équipes' },
        { src: 'assets/projects/equality-players.jpg', cap: 'Joueurs' },
      ],
    ...
    {
      id: 'ikea',
      name: 'IKEA × Día de los Muertos',
      shortName: 'IKEA Día',
      year: 'Exercice · 2h',
      type: 'Exercice de style · UI · Branding',
      role: 'UI Designer — page événementielle thématique',
      context: `Page événementielle pour IKEA autour du Día de los Muertos · Respect strict de l'identité de marque · Territoire inhabituel`,
      tags: ['UI', 'BRANDING', '2H'],
      categories: ['da'],
      contract: [],
      cover: 'ikea',
      tagline: `Emmener une marque aux règles visuelles très strictes dans un territoire qu'elle n'occupe pas d'habitude.`,
      challenge: `IKEA a des règles visuelles très strictes — la liberté créative se joue dans les marges. Concevoir une page Día de los Muertos qui reste 100% IKEA tout en honorant l'esthétique mexicaine de la fête.`,
      process: [
        { title: 'CADRAGE BRAND', text: `Analyse des guidelines IKEA : grille, typographie, couleurs autorisées, ton. Identification des marges de manœuvre exploitables.` },
        { title: 'UI THÉMATIQUE', text: `Page événementielle composée en 2h chrono — motifs papel picado stylisés dans la grille IKEA, palette dérivée des couleurs marque.` },
      ],
    ...
    {
      id: 'yungo',
      name: 'Teen Bank — Youngo',
      shortName: 'Youngo',
      year: 'Projet école',
      type: 'Projet école · Direction artistique',
      role: 'UI Designer · Direction artistique',
      context: `Banque mobile pour les 12-17 ans · Fintech · Produit financier engageant et rassurant pour des ados`,
      tags: ['UI', 'FINTECH', 'DA'],
      categories: ['ux', 'da'],
      contract: [],
      cover: 'yungo',
      tagline: `Rendre un produit financier engageant et rassurant pour des ados, sans tomber dans le condescendant.`,
      challenge: `Concevoir pour des mineurs impose une responsabilité particulière — clarté absolue, zéro dark pattern. L'app doit parler aux 12-17 ans sans infantiliser, et rassurer les parents sans ennuyer les ados.`,
      process: [
        { title: 'DIRECTION ARTISTIQUE', text: `Identité visuelle énergique : carte bancaire signature, palette électrique, typographie display. Un objet que les ados ont envie de montrer.` },
        { title: 'UI & PARCOURS', text: `Parcours simplifiés : solde lisible en un coup d'œil, catégorisation visuelle des dépenses, garde-fous parentaux intégrés sans stigmatiser.` },
      ],
    ...
    },
    {
      ...
      role: 'UI Designer — exploration de style',
      context: `Concept UI sur l'univers Squid Game · Exploration neumorphism · Ombres portées et relief sur fond uniforme`,
      tags: ['UI', 'NEUMORPH.'],
      categories: ['ux'],
      contract: [],
      cover: 'squidui',
      tagline: `S'approprier le neumorphism — un style séduisant en théorie, exigeant en pratique.`,
      challenge: `Le neumorphism repose sur des contrastes faibles qui créent de vraies tensions avec l'accessibilité. L'univers Squid Game s'y prêtait : tension, règles, hiérarchie stricte — mais il fallait garder l'interface lisible.`,
      process: [
        { title: 'EXPLORATION STYLE', text: `Études d'ombres et de relief sur fond uniforme. Calibrage des élévations pour distinguer états actifs/inactifs malgré le faible contraste.` },
        { title: 'UI CONCEPT', text: `Écrans clés de l'univers Squid Game déclinés en neumorphism : compteurs, cartes joueurs, hiérarchie des règles.` },
      ],
      result: `Concept UI complet. Conclusion documentée : le neumorphism exige des compromis d'accessibilité difficilement justifiables en production.`,
      skills: ['UI Design', 'Neumorphism', 'Exploration visuelle', 'A11y awareness'],
      screenshots: [],
    },
    {
      id: 'lacopain',
    ...
    },
    {
      ...
      role: 'Designer & développeuse Webflow — de l\'invitation au RSVP',
      context: `Site d'invitation + RSVP fonctionnel pour le mariage de Claire & Maxime · Cible multigénérationnelle`,
      tags: ['WEBFLOW', 'UI', 'PERSO'],
      categories: ['ux'],
      contract: [],
      cover: 'savedate',
      url: 'https://claire-maxime.webflow.io/',
      tagline: `Le brief le plus personnel qui soit : zéro droit à l'erreur sur l'émotion.`,
      challenge: `Cible multigénérationnelle — grands-parents inclus. Simplicité radicale obligatoire : chaque invité, quel que soit son niveau digital, doit pouvoir confirmer sa présence sans aide.`,
      process: [
        { title: 'UI & ÉMOTION', text: `Identité douce et florale fidèle au couple. Hiérarchie limpide : la date, le lieu, le bouton RSVP — rien ne détourne l'attention.` },
        { title: 'WEBFLOW & RSVP', text: `Développement Webflow avec formulaire RSVP fonctionnel, gestion des réponses, version mobile prioritaire.` },
      ],
    ...
    },
    {
      ...
      role: 'UI Designer · Développeuse Webflow',
      context: `Site vitrine pour un restaurant de burgers · Identité gourmande et directe · Conversion locale`,
      tags: ['WEBFLOW', 'UI'],
      categories: ['ux', 'da'],
      contract: ['freelance'],
      cover: 'redburger',
      tagline: `Site vitrine appétissant — l'envie de burger en un scroll.`,
      challenge: `Faire saliver en ligne : un site de restaurant se juge en quelques secondes. Hiérarchie simple — la carte, les horaires, l'adresse — sans sacrifier la personnalité de la marque.`,
      process: [
        { title: 'UI GOURMANDE', text: `Direction visuelle bold : couleurs chaudes, photos produits en grand, typographie display. Le burger est le héros de chaque écran.` },
        { title: 'WEBFLOW', text: `Développement responsive avec accès direct carte/horaires/itinéraire. Optimisation mobile — la majorité des visites vient du local.` },
      ],
  ...
  iaAgents: [
    ...
    { id: 'yogary', name: 'Gary 🐺', age: 'Chien', domain: 'Bonheur inconditionnel', role: 'Mon chien', tone: 'Waf · Thuper enthousiaste · 100% floofy', usage: `Quand tout le reste est trop sérieux.`, designNote: `Le seul agent dont le brief tenait en un mot : Gary.`, photo: 'assets/agents/yogary.png', video: 'assets/videos/yogary.mp4' },
  ],
