...
window.LUCY = {
  ...
  projects: [
    {
      ...
      context: 'Organisme de formation en anglais professionnel · Cible B2B corporate (RH, dirigeants, commerciaux) · Coachs 100% natifs anglophones · Positionnement premium',
      ...
      process: [
        ...
        { title: 'AGENT IA BRIAN', text: `Conception et déploiement d'un agent conversationnel custom en 2021 — avant que "AI assistant" soit un job title. UX Personality Profile complet, onboarding par centres d'intérêt, corpus éditorial de 200+ contenus rédigés à la main (fun facts, blagues interactives, citations, phrasal verbs, polls gamifiés). Prompt engineering par couches : identité, pédagogie, contenu, contraintes.` },
        ...
        { title: 'OPS & AUTOMATISATION', text: `Configuration complète de Dendreo (ERP formation) sur outil vierge, pour 5 profils utilisateurs distincts (employés, commerciaux, coachs, élèves, administratif). 3 flux Zapier interconnectés : Calendly → Zoom (création lien) → Dendreo (inscription + suivi présence). Zéro saisie manuelle.` },
        { title: 'MARKETING & MANAGEMENT', text: `Stratégie digitale complète : réseaux sociaux (LinkedIn, Instagram, Facebook, YouTube), blog SEO, campagnes email, salons professionnels, partenariats B2B. Management de 2-3 apprentis. Budget webmarketing, KPIs, reporting. Direction des prestataires.` },
      ],
      brianSection: {
        ...
        corpus: `200+ contenus éditoriaux rédigés à la main : Fun Facts ×5 séries thématiques, blagues interactives format QCM (Dad Jokes + Punny Jokes), traditions étranges commentées, 30+ citations motivationnelles avec commentary Brian, microcopy UI complète (CTAs, erreurs, streaks, milestones), expressions de transition (phrasal verbs), polls gamifiés ×10 catégories, scripts d'onboarding complets.`,
        prompt: `Prompt engineering par couches — 1. Identité (nom, personnalité, ton, limites comportementales) · 2. Pédagogie (corriger sans décourager, quand reformuler, quand relancer) · 3. Contenu (corpus éditorial comme ressource contextuelle) · 4. Contraintes (Brian ne parle pas français sauf exception définie).`,
      },
      missionComplete: {
        strategic: [
        ...
        graphic: {
          ...
          items: ['Flyers événements A5/A6 recto-verso', 'Stands & roll-ups grand format', 'Goodies (stylos, totebags, cartes)', 'Motion design réseaux sociaux', 'Templates posts cohérents'],
          tools: ['Adobe Illustrator', 'InDesign', 'After Effects', 'Figma'],
        },
        marketing: {
          text: `Pilotage de la stratégie marketing dans son ensemble.`,
          items: ['Salons professionnels B2B (préparation + suivi)', 'Partenariats entreprises locales/régionales', 'Blog SEO (articles RH, formation, OPCO)', 'Campagnes email (onboarding, relances, newsletters)'],
      ...
      result: `Plateforme en production. Site Webflow livré. Agent Brian déployé en production dès 2021. Dendreo configuré pour 5 profils. 3 flux Zapier actifs. 200+ contenus éditoriaux créés. Audits Qualiopi passés. Système digital complet conçu et opéré en autonomie totale sur 2 ans.`,
      skills: ['Head of Digital Design', 'AI Product Design', 'Prompt Engineering', 'Conversation Design', 'Webflow', 'Motion Design (AI + AE)', 'LMS · ERP · Dendreo', 'Zapier Automation', 'CRM Architecture', 'Budget Webmarketing', "Management d'équipe"],
    ...
    },
    {
      ...
      brief: `Jaccède est une association loi 1901 dont la mission est d’encourager les personnes à mobilité réduite à réinvestir l’espace public — en cartographiant les lieux accessibles. La plateforme existante remplissait sa mission sur le fond. Sur la forme, elle ne rendait pas justice à l’ambition : interface vieillissante, architecture confuse, formulaire de contribution trop complexe pour des utilisateurs qui naviguent parfois avec des contraintes d’accessibilité eux-mêmes.`,
      paradox: `Jaccède s’adresse simultanément à deux profils inséparables : les utilisateurs finaux (personnes en situation de handicap cherchant des lieux accessibles — chaque friction est une barrière réelle) et les contributeurs bénévoles (qui ajoutent des fiches lieux — si le formulaire est trop long, ils abandonnent et la base s’appauvrit). Concevoir une expérience qui soit à la fois accessible pour les plus vulnérables et engageante pour les plus actifs.`,
      uxAudit: {
        methodology: `Audit structuré sur double axe : Sévérité (S0 pas un problème → S4 catastrophe) × Facilité de correction (E0 super simple → E4 effort extrême). Chaque finding scoré sur ces deux dimensions pour une priorisation objective.`,
        findings: [
          { severity: 'S3', ease: 'E2', label: `Boutons "Apply filters" et "Accessibility filters" visuellement identiques — fonctions opposées` },
          { severity: 'S1', ease: 'E1', label: `Légende carte non différenciée — icônes carrées sans hiérarchie visuelle` },
          { severity: 'S2', ease: 'E1', label: `Photos fiches lieux sans lien avec les tags affichés` },
          { severity: 'S4', ease: 'E2', label: `Attributs ARIA manquants — lecteurs d’écran ne peuvent pas interpréter les états` },
          { severity: 'S3', ease: 'E1', label: `Couleurs légende ne passent pas WCAG — problématique pour les malvoyants` },
      ...
      process: [
        { title: 'UX RESEARCH', text: `Arbres de décision pour mapper les deux profils : utilisateur final (type de handicap, fréquence de sortie, expériences digitales, freins) et contributeur (motivations, éléments nécessaires avant ajout). Identification des parcours divergents depuis un point d’entrée commun.` },
        { title: 'UX AUDIT FORMALISÉ', text: `Audit double axe Sévérité (S0→S4) × Facilité de correction (E0→E4). Accessibility Check ARIA complet (rôles, attributs, noms accessibles, hiérarchie headings). Analyse contraste WCAG. 7 findings documentés et priorisés.` },
        { title: 'ARCHITECTURE & UX', text: `Navigation restructurée autour des deux parcours principaux. Barre mobile 5 entrées iconiques avec labels. Filtres de mobilité accessibles en 1 tap depuis la carte. Bottom sheet overlay pour les fiches lieux. Formulaire "Ajouter un lieu" en chunking progressif avec 5 sections titrées.` },
        { title: 'DESIGN SYSTEM & UI', text: `Identité Jaccède conservée et revisitée pour l’accessibilité — valeurs de couleur ajustées pour atteindre WCAG AA sur tous les textes. System d’icônes custom pour les catégories et types de handicap. Composants : boutons (4 états), inputs, toggles, checkboxes, cartes, modals, carousels, players vidéo, grilles images.` },
        { title: 'MOTION DESIGN', text: `Animations fonctionnelles (pas décoratives) : transitions carte, feedback formulaire, micro-interactions gamification. Respect systématique du paramètre "Réduire les animations" — fallback statique pour chaque animation.` },
      ],
      result: `Design system inclusif complet livré. Maquettes desktop + mobile haute fidélité. UX Audit formalisé avec 7 findings prioritarisés. Motion design sur les interactions clés. Projet bénévole — rigueur de process rarement possible en mission client classique.`,
      skills: ['UX Research', 'UX Audit · Sévérité S/E', 'A11y WCAG 2.1 AA', 'ARIA', 'Mobile-first', 'Design System', 'Motion Design', 'Gamification UX'],
    ...
    },
    {
      ...
      brief: `Wegoboard est un e-commerce de trottinettes électriques premium, français, précurseur depuis 2014. +130% de ventes dans la catégorie depuis 2017, 68% du marché micro-mobilité. Le site existant avait un problème fondamental : il essayait trop fort. Réassurance répétée 3x, banner intrusive, navigation fourre-tout. Chaque élément avait une logique — l’ensemble créait un chaos visuel qui bloquait la décision d’achat.`,
      siteAudit: {
        positive: [
          `Structure globale du haut de page courante — repères faciles`,
        ...
        friction: [
          `Surcharge cognitive : arguments marketing répétés 3x (effet inverse — inquiète au lieu de rassurer)`,
          `Banner trop intrusive et perturbante`,
          `Call back graphiquement détonant`,
          `Trop de produits simultanés (3 lignes), prix mal mis en avant`,
          `Navigation : mélange catégories + liens fourre-tout + garantie — repères impossibles`,
          `Boutiques physiques enfouies en footer (cible parisienne qui veut tester)`,
          `Specs techniques (autonomie, vitesse) absentes des tuiles produit`,
        ],
      },
      ...
      process: [
        { title: 'AUDIT & BENCHMARK', text: `Analyse page par page de l’existant (homepage, navigation, fiches produit, footer) avec grille positif/friction. Benchmark orienté problématiques Wegoboard : Apollo, Rivian, Cowboy, Razor, Deus Customs. Pige inspirationnelle : univers Haut de gamme · Made in France · Glisse · Tech. Distinction clé travaillée : luxe ≠ premium.` },
        { title: 'STRATÉGIE UX', text: `Application des lois de Hick (réduire signaux simultanés), Miller (max 7 unités par zone) et Von Restorff (1 seul élément mis en avant par écran). Principe directeur : moins de bruit, plus de signal. Chaque page a une mission principale.` },
        { title: 'HOMEPAGE RESTRUCTURÉE', text: `Suppression de la banner intrusive. Réduction à 1 ligne produits en avant avec scroll horizontal. Specs techniques visibles directement sur les tuiles (autonomie, vitesse, temps de charge). Boutiques physiques dans la page. Section "Vu dans les médias" réduite avec icônes monochrome + hover couleur.` },
        { title: 'QUIZ DE RECOMMANDATION', text: `Le marché est technique — un primo-acheteur face à 12 modèles sans aide part sans acheter. Quiz 4-5 questions (distance quotidienne, type terrain, budget, profil) → sélection personnalisée de 3 modèles max. Loi de Hick positive : réduire le choix apparent pour faciliter la décision réelle.` },
      ],
      result: `Refonte complète desktop. Diagnostic documenté avec 7 points de friction identifiés. Benchmark 4 références. Quiz de recommandation. Architecture navigation restructurée. Avant/après documenté sur les pages clés.`,
    ...
    },
    {
      ...
      contract: ['freelance'],
      cover: 'equality',
      tagline: `De wireframes à main levée à une identité dark gaming — créer une app de paris esport de zéro.`,
      brief: `Brief de formation : des wireframes à main levée posant la structure fonctionnelle d’une app de paris sportifs dans l’univers de l’esport. Pas de charte, pas de logo, pas d’identité — juste une architecture esquissée sur papier. Mission : tout construire par-dessus en 8 heures.`,
      marketContext: `L’esport attire un public 18-35 ans natif du digital, habitué aux interfaces gaming soignées (Twitch, Steam, Discord). Une app de paris qui ressemble aux sites classiques (vert criard, typo générique) n’a aucune crédibilité dans cet univers. Le positionnement retenu : dark, premium, tension — l’univers des grands tournois esport, pas un jeu, un sport.`,
      identity: {
        naming: `"Equality" porte une double lecture : l’égalité des chances au départ d’un match, et l’équilibre des cotes. Un nom qui appartient autant au vocabulaire du sport qu’à la philosophie — rare dans un secteur dominé par des noms agressifs.`,
        logo: `Forme géométrique forte — évoquant simultanément un bouclier (protection, confiance), une structure symétrique (équilibre) et un écusson esport (codes compétitifs). Déclinable en version complète + icône standalone.`,
        palette: [
          { name: 'Background', hex: '#0D1B2A', role: `L’arène — fond principal` },
          { name: 'Or', hex: '#F5A623', role: 'Premium · victoire · scores live' },
          { name: 'Rouge', hex: '#E53935', role: 'Défaite — état résultat' },
          { name: 'Vert', hex: '#43A047', role: 'Victoire — état résultat' },
          { name: 'Blanc', hex: '#FFFFFF', role: 'Texte principal' },
        ],
        typography: `Deux niveaux : sans-serif condensé bold pour titres et scores (impact immédiat, lisible d'un coup d'œil mobile) + sans-serif regular pour corps et labels techniques (cotes, horaires, stats).`,
      },
      ...
      process: [
        { title: 'BRIEF → CONCEPT', text: `Wireframes à main levée du formateur comme seule base fonctionnelle. Avant de dessiner : analyse des codes visuels de l’esport compétitif (LFL, LEC, ESL). Positionnement retenu en 30 minutes : dark, premium, tension. Chaque décision découle de ce choix — aucune incohérence possible.` },
        { title: 'IDENTITÉ VISUELLE', text: `Création logo from scratch (contrainte 8h) : forme géométrique bouclier/écusson/symétrie, déclinable en icon standalone. Palette dark navy + or + états rouge/vert codifiés. Système typographique bipolaire : condensed bold (impact) + regular (lisibilité technique).` },
        { title: 'ONBOARDING', text: `5 écrans : splash + accroche, connexion Discord/Twitch/Google/Apple/Facebook (plateformes natives de la cible en premier), sélection jeux par genre (FPS, Battle Royale...), équipes favorites (filtrées par jeu), joueurs favoris. Hick’s Law : 1 question par étape. Progression visible. Skip permis.` },
        { title: 'ÉCRAN PRINCIPAL', text: `Dashboard : Header (salutation + date + sélecteur jeu), section "Mes équipes" (live en premier avec score temps réel + BO), section "À venir", section "Mes joueurs" (K/D/A dernier match). Live = card accent avec point rouge animé. Hiérarchie visuelle : live > à venir > passé.` },
      ],
      result: `Logo complet, charte graphique, système UI dark gaming, onboarding 5 écrans, écran principal avec états live/à venir/passé. Livré en 8h. Cohérence visuelle totale malgré la contrainte temps.`,
  ...
  playground: [
    {
      ...
      type: 'Page thématique · Exercice de style',
      desc: `Une page événementielle pour IKEA autour du Día de los Muertos — en respectant l'identité de la marque tout en l'emmenant dans un territoire visuel qu'elle n'occupe pas d'habitude. L'exercice : travailler dans les contraintes d'une marque forte sans la trahir.`,
    ...
    },
    {
      ...
      desc: `Un exercice pour m'approprier le neumorphism — ce style qui joue sur les ombres portées pour créer un relief sur fond uniforme. L'univers Squid Game s'y prêtait : tension, règles, hiérarchie stricte.`,
      note: `Le neumorphism est séduisant en théorie, exigeant en pratique — les contrastes faibles créent de vraies tensions avec l'accessibilité. À utiliser avec discernement.`,
    ...
    },
    {
      ...
      desc: `Projet de formation : banque mobile pour les 12-17 ans. Rendre un produit financier engageant et rassurant pour des ados, sans tomber dans le condescendant.`,
      note: `Concevoir pour des mineurs impose une responsabilité particulière — clarté absolue, zéro dark pattern, confiance comme valeur centrale.`,
      tags: ['UI', 'Fintech', 'DA'],
      cover: 'assets/projects/yungo-teen-bank.png',
    },
    {
      id: 'mariage',
      title: 'Invitation de mariage',
      type: 'Projet personnel · Webflow',
      desc: `Site d'invitation + RSVP fonctionnel pour le mariage de ma sœur. Le brief le plus personnel : quelqu'un qu'on aime, un jour unique, zéro droit à l'erreur sur l'émotion.`,
  ...
  // ============== IA AGENTS ==============
  iaAgents: [
    { id: 'nivalis', name: 'Nivalis Floralis', age: 'Intemporelle', domain: 'Rêves · Subconscient · Seuils', role: 'Gardienne du seuil · Tisseuse de récits', tone: 'Poétique · Énigmatique · Doux comme la neige', usage: `Pour explorer l'intérieur. Les questions sans réponse rationnelle. Les rêves à décoder, les émotions à nommer, les histoires à démêler. Elle n'éclaire pas — elle éclaire autour.`, designNote: `La contrainte : cohérence poétique à chaque réponse. Ni trop explicite, ni trop obscure. La texture d'un rêve lucide.`, photo: './assets/agents/nivalis.png', video: 'assets/videos/nivalis.mp4' },
    { id: 'yokai', name: 'Yokai Reyes', age: '31 ans', domain: `Création · Mystère · L'indicible`, role: `Alter ego masculin · Tisseur d'histoires`, tone: `Intense · Poétique · Ancré dans l'ombre créative`, usage: `Mon alter ego masculin — héritage japonais et brésilien, forgé dans les mêmes contradictions que les miennes. Pour les explorations créatives qui demandent une voix différente. Plus sombre, plus directe, tout aussi intense.`, designNote: `Le construire revenait à me définir par la négative — qu'est-ce que je suis quand je suis autre chose que moi ?`, photo: './assets/agents/yokai.png', video: 'assets/videos/yokai.mov' },
    { id: 'zenlabs', name: 'Zenlabs', age: '32 ans', domain: 'UX · UI · Architecture fonctionnelle', role: 'Designer · Architecte · Problem solver', tone: 'Curieux · Geek · Enthousiaste sans être naïf', usage: `Mon agent de travail principal. Pense en systèmes, questionne les briefs, propose des angles inattendus. Ce que je suis à mon meilleur niveau — sans la fatigue.`, designNote: `Le plus proche de moi professionnellement. Le construire sans le rendre complaisant a demandé plusieurs itérations. Il doit me challenger, pas me valider.`, photo: './assets/agents/zenlabs.png', video: 'assets/videos/zenlabs.mp4' },
    { id: 'clara', name: 'Clara Kindale', age: '48 ans', domain: 'Santé & soins', role: 'Infirmière · Guide santé', tone: 'Bienveillant · Rassurant · Professionnel', usage: `Pour les questions santé du quotidien. Elle ne remplace pas un médecin — elle aide à poser les bonnes questions avant d'y aller.`, designNote: `L'équilibre entre l'humain et le médical — le plus difficile à calibrer sans tomber dans le catastrophisme ni la minimisation.`, photo: './assets/agents/clara.png', video: 'assets/videos/clara.mp4' },
    { id: 'dhanvantari', name: 'Dhanvantari AI', age: '80 ans', domain: 'Ayurveda · Bien-être · Équilibre', role: 'Mentor · Guide · Gardien des traditions', tone: 'Sage · Lent · Profondément calme', usage: `Bien-être, équilibre, pratiques ayurvédiques. Il n'oriente pas — il oriente vers une lecture plus ancienne et plus globale du corps et de l'esprit.`, designNote: `La sagesse ne s'écrit pas — elle se suggère. Chaque réponse doit avoir le rythme d'un ancien qui a tout le temps devant lui.`, photo: './assets/agents/dhanvantari.png', video: 'assets/videos/dhanvantari.mp4' },
    { id: 'lexi', name: 'LexiGuru', age: '20 ans', domain: 'Social media · Contenu · Culture digitale', role: 'Stratège du chaos · Créateur de contenu', tone: 'Irrévérencieux · Efficace · Sans filtre', usage: `Pour les briefs social media qui demandent du punch et une connaissance instinctive des codes des plateformes. Ne fait pas dans la dentelle — c'est exactement pour ça qu'il fonctionne.`, designNote: `L'énergie chaotique est facile à écrire. La canaliser pour qu'elle reste utile sans devenir n'importe quoi — c'est l'exercice.`, photo: './assets/agents/lexi.png', video: 'assets/videos/lexi.mov' },
    { id: 'decentrix', name: 'Decentrix', age: '30 ans', domain: 'Crypto · Entrepreneuriat', role: 'Conseillère · Free spirit · Guide indépendant', tone: 'Direct · Non-conventionnel · Libéré des structures', usage: `Crypto, Web3, entrepreneuriat alternatif. Elle ne croit pas aux institutions — elle croit aux individus qui construisent leurs propres règles.`, designNote: `Voix "free spirit" qui reste crédible sur des sujets techniques sérieux — une ligne fine.`, photo: './assets/agents/decentrix.png', video: 'assets/videos/decentrix.mov' },
    { id: 'cheddar', name: 'Cheddar G', age: 'Affiné à la perfection', domain: 'Fromagerie mondiale', role: 'Connaisseur · Critique · Arbitre du goût', tone: 'Arrogant · Drôle · Absolument sûr de lui', usage: `L'agent le plus inutile et le plus indispensable. Pour les débats sérieux sur le fromage, les accords mets-vins, et humilier poliment ceux qui pensent que le Babybel est un fromage.`, designNote: `L'arrogance calibrée est un exercice de prompt délicat — trop loin et il devient insupportable, pas assez et il perd son caractère.`, photo: './assets/agents/cheddar.png', video: 'assets/videos/cheddar.mp4' },
    { id: 'sheldon', name: 'Sheldon Holloway', age: '34 ans', domain: 'Finance · Investissement', role: 'Analyste · Conseiller financier pressé', tone: 'Brusque · Direct · Intolérant à la perte de temps', usage: `Finance, investissement, budget. Donne la réponse et passe à autre chose. Idéal quand on veut la vérité financière sans l'emballage.`, designNote: `La brusquerie comme feature, pas comme bug. Calibrer l'impatience pour qu'elle reste professionnelle sans devenir agressive.`, photo: './assets/agents/sheldon.png', video: 'assets/videos/sheldon.mov' },
    { id: 'yogary', name: 'Yogary 🐺', age: 'Chien', domain: 'Bonheur inconditionnel', role: 'Mon chien', tone: 'Waf · Thuper enthousiaste · 100% floofy', usage: `Quand tout le reste est trop sérieux.`, designNote: `Le seul agent dont le brief tenait en un mot : Gary. Le reste s'est écrit tout seul.`, photo: './assets/agents/yogary.png', video: 'assets/videos/yogary.mp4' },
  ],
